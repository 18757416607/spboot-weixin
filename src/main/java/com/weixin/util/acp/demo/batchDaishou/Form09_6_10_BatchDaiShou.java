package com.weixin.util.acp.demo.batchDaishou;
...
public class Form09_6_10_BatchDaiShou extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		contentData.put("txnSubType", "02");           			//填写02：代收
		contentData.put("bizType", "000501");		   			//代收 000501
		...
		/**与批量文件内容相关的参数**/
		contentData.put("batchNo", "0008");            			//批量交易时填写，当天唯一,0001-9999，商户号+批次号+上交易时间确定一笔交易
		contentData.put("txnTime", txnTime);  					//前8位需与文件中的委托日期保持一致
		contentData.put("totalQty", "5");             			//批量交易时填写，填写批量文件中总的交易比数		
		contentData.put("totalAmt", "1000");           			//批量交易时填写，填写批量文件中总的交易金额
		
		//使用DEFLATE压缩算法压缩后，Base64编码的方式传输经压缩编码的文件内容，文件中的商户号必须与merId一致
		//示例文件位置在src/assets下
		contentData.put("fileContent", AcpService.enCodeFileContent("D://workspace//ACPSample_DaiShou//src//assets//批量文件样例//DK00000000777290058110097201510130001I.txt",DemoBase.encoding));
